...
export const getPosts = (count) => {
    return (dispatch) => {
        return axios
            ...
            .then((res) => {
                const array = res.data.slice(0, count); // Limite le nbr de posts qui seront affichés de 0 à count
...
export const likePost = (postId, userId) => {
    return (dispatch) => {
        ...
        .then((res) => {
            // DEF : Payload <=> infos qui seront traitées
